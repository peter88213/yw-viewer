...
[Download the latest release (version 2.0.0)](https://raw.githubusercontent.com/peter88213/yw-viewer/main/dist/yw-viewer_v2.0.0.zip)

- Unzip the downloaded zipfile "yw-viewer_v2.0.0.zip" into a new folder.
