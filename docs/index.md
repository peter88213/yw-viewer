...
[Download the latest release (version 0.2.2)](https://raw.githubusercontent.com/peter88213/yw-viewer/main/dist/yw-viewer_v0.2.2.zip)

- Unzip the downloaded zipfile "yw-viewer_v0.2.2.zip" into a new folder.
