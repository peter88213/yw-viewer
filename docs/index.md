...
[Download the latest release (version 1.3.0)](https://raw.githubusercontent.com/peter88213/yw-viewer/main/dist/yw-viewer_v1.3.0.zip)

- Unzip the downloaded zipfile "yw-viewer_v1.3.0.zip" into a new folder.
