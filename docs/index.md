...
[Download the latest release (version 2.4.8)](https://raw.githubusercontent.com/peter88213/yw-viewer/main/dist/yw-viewer_v2.4.8.zip)

- Unzip the downloaded zipfile "yw-viewer_v2.4.8.zip" into a new folder.
