...
[Download the latest release (version 0.2.5)](https://raw.githubusercontent.com/peter88213/yw-viewer/main/dist/yw-viewer_v0.2.5.zip)

- Unzip the downloaded zipfile "yw-viewer_v0.2.5.zip" into a new folder.
