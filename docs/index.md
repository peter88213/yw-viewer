...
[Download the latest release (version 0.4.1)](https://raw.githubusercontent.com/peter88213/yw-viewer/main/dist/yw-viewer_v0.4.1.zip)

- Unzip the downloaded zipfile "yw-viewer_v0.4.1.zip" into a new folder.
