...
### Version 2.2.5 Update setup script

- Change the working dir to the script dir on startup in order to avoid "file not found" error.

Based on PyWriter version 5.18.0

### Version 2.2.4 Improved setup
...
### Version 2.2.2 Improved word counting
...
Based on PyWriter version  4.0.1
...
### Version 1.2.0 Rich text display
...
### Version 0.4.1 Improve error handling

- Show a message in the status bar if the yw7 project cannot be read.

Based on PyWriter version  3.32.3
...
### Version 0.2.7 Bugfix alpha release
...
### Version 0.2.6 Fix the display

- Do not expand the info bars.

Based on PyWriter version  3.32.3

### Version 0.2.5 Show stats
...
### Version 0.2.3 Optional alpha release
